...
public class SearchTest extends TestBase {
    ...
    void searchAnnouncementWithResult0Test() {
        ...
        searchPage.checkResultsEquals0("Ничего не найдено по запросу «скунс трёхцветный»");
    }
    ...
    void searchAnnouncementAndSubscribeToSearchTest() {
        ...
        popUpNotificationPage.checkNameSavedSearchHeaderRoot("Добавьте поиск в избранное")
                .clickAtButtonAdd()
